...
import static com.rance.chatui.util.TransCode.sourceToByte;
            ...
            case CROP_PHOTO:
                if (res == Activity.RESULT_OK) {
                    try {
                        ...
                        messageInfo.setImageBase64(sourceToByte(imageUri.getPath()));
            ...
            case REQUEST_CODE_PICK_IMAGE:
                if (res == Activity.RESULT_OK) {
                    try {
                        ...
                        messageInfo.setImageBase64(sourceToByte(getRealPathFromURI(uri)));
                        EventBus.getDefault().post(messageInfo);
                    } catch (Exception e) {
                        e.printStackTrace();
